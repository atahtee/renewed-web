      ...
      <section className="max-w-2xl w-full py-12">
        ...
        <div className="space-y-6 text-gray-700 text-sm sm:text-base">
          <div>
            ...
            <p>
              Renewed is designed to help you manage subscriptions with minimal data collection. We store your data locally on your device and only collect whats necessary to provide reminders and improve the app.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              <ul className="list-disc pl-5 mt-2">
                <li>Subscription details you enter (e.g., name, amount, start date), stored locally on your device.</li>
              ...
              We dont collect personal identifiers like your name, email, or payment details.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              We dont use your data for advertising or any other purpose.
            </p>
          </div>
